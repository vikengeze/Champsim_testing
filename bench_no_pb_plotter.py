...
path_no_pb = '/home/sonqo/Desktop/Diplom/bench_results/bench_no_pb/'
folder = ''
ipc = 0
...
def sort_files(files, pref):
	for file in files:
		with open(path_no_pb + pref + '/' + file) as f:
			lines = f.readlines()
		for line in lines:
...
for key in gap_ipcs:
	...
	#plt.show()
	plt.savefig('plots/pb_not_used/singles/' + get_folder(key) + '/' + key.split('_')[0] + '.png', dpi=300)
	plt.clf()
...
#plt.show()
plt.savefig('plots/pb_not_used/total/gap_total.png', dpi=600)
plt.clf()
...
#plt.show()
plt.savefig('plots/pb_not_used/total/spec06_total.png', dpi=600)
plt.clf()
...
#plt.show()
plt.savefig('plots/pb_not_used/total/spec17_total.png', dpi=600)
plt.clf()
...
#plt.show()
plt.savefig('plots/pb_not_used/total/final_total.png', dpi=600)
plt.clf()